...
?>
<!-- Full Page Intro -->
  <div class="view home-intro" style="background-image: url('<?php echo get_template_directory_uri(); ?>/img/main-photo.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 white-text text-center text-md-left mt-xl-4 mb-5">
            ...
            <span class="h1-responsive  mt-3 mb-4 text-center wow fadeIn" data-wow-delay="0.5s">
            ...
            <div class="text-center mt-5">
              ...
              <a href="<?php echo esc_url( home_url( '/' ) ); ?>rekomendacja/" class="btn btn-gray btn-lg wow fadeInUp" role="button" data-wow-delay="0.9s">Zarekomenduj Sygnalizuj.com <i class="fas fa-thumbs-up fa-lg ml-2"></i></a>
            </div>
          </div>
          <!--Grid column-->
        </div>
